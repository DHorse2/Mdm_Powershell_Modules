...
irm 'https://raw.githubusercontent.com/springcomp/my-box/master/bootstrap/Install-Pwsh_Core.ps1' `
	-OutFile $env:TEMP\Install-Pwsh_Core.ps1

$pwsh = "$env:LOCALAPPDATA\Microsoft\powershell\pwsh.exe"
. $pwsh -nologo -noprofile -file "$env:TEMP\Install-Pwsh_Core.ps1"
